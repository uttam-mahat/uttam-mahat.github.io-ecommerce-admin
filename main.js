...
var map = {
	...
	"./village-profile/village-profile.module": [
		"./src/app/village-profile/village-profile.module.ts",
		"village-profile-village-profile-module"
	],
	"./ward-structure/ward-structure.module": [
...
/* harmony import */ var _services_localstorage_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./_services/localstorage.service */ "./src/app/_services/localstorage.service.ts");
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
/* harmony import */ var _travel_and_tourism_travel_and_tourism_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./travel-and-tourism/travel-and-tourism.component */ "./src/app/travel-and-tourism/travel-and-tourism.component.ts");
/* harmony import */ var _mountain_list_mountain_list_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./mountain-list/mountain-list.component */ "./src/app/mountain-list/mountain-list.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _travel_and_tourism_travel_and_tourism_component__WEBPACK_IMPORTED_MODULE_26__["TravelAndTourismComponent"],
                _mountain_list_mountain_list_component__WEBPACK_IMPORTED_MODULE_27__["MountainListComponent"]
            ],
            imports: [
            ...
            providers: [
                ...
                { provide: ng_recaptcha__WEBPACK_IMPORTED_MODULE_25__["RECAPTCHA_V3_SITE_KEY"], useValue: '6LddHaYZAAAAAAvDJgO8qBHfefPkTPxEwVm0qhTb' },
                _services_localstorage_service__WEBPACK_IMPORTED_MODULE_24__["LocalStorageService"]
            ],
...
/* harmony import */ var _travel_and_tourism_travel_and_tourism_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./travel-and-tourism/travel-and-tourism.component */ "./src/app/travel-and-tourism/travel-and-tourism.component.ts");
/* harmony import */ var _mountain_list_mountain_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./mountain-list/mountain-list.component */ "./src/app/mountain-list/mountain-list.component.ts");
...
var router = [
    ...
    { path: 'reports', component: _reports_reports_component__WEBPACK_IMPORTED_MODULE_11__["ReportsComponent"] },
    ...
    { path: 'travel-and-tourism', component: _travel_and_tourism_travel_and_tourism_component__WEBPACK_IMPORTED_MODULE_12__["TravelAndTourismComponent"] },
    { path: 'mountain-list', component: _mountain_list_mountain_list_component__WEBPACK_IMPORTED_MODULE_13__["MountainListComponent"] },
    {
        path: '',
    ...
    },
    {
        ...
        loadChildren: './village-profile/village-profile.module#VillageProfileModule',
    },
    {
        path: 'ward-structure',
        loadChildren: './ward-structure/ward-structure.module#WardStructureModule',
    },
];
...
module.exports = "/* geo satellite section start */\n.geo-satellite-item {\n  padding: 120px 0;\n  background: #e8e8e8;\n  text-align: center; }\n/* geo satellite section close */\n/* incident-report section start */\n.incident-report-citizen .section-blurb {\n  min-height: unset; }\nsection.incident-report-citizen .col-12 {\n  padding: 0; }\nsection.incident-report-citizen .row {\n  margin: 0; }\n.flex-btn-item {\n  padding: 15px;\n  text-align: center;\n  border: 1px solid #ccc;\n  margin-left: -1px;\n  transition: all 0.4s ease; }\n.flex-btn-item:hover {\n  background: #f3f3f3;\n  cursor: pointer; }\n/* incident-report section close */\n/* yearly incident in brief start */\n.yearly-incident-brief .section-blurb {\n  min-height: unset; }\n.yearly-incident-brief .col-12 {\n  padding: 0; }\n.yearly-incident-brief .row {\n  margin: 0; }\n.yearly-incident-brief .flex-btn-item {\n  padding: 15px 0 0;\n  margin-bottom: 24px; }\n.yearly-incident-brief .icon {\n  width: 100%;\n  margin: 0 auto; }\n.yearly-incident-brief .icon img {\n  width: 100%; }\n/* yearly incident in brief close */\n/* incident facts in brief start */\n.search-filter-wrapper {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  align-items: center;\n  justify-content: flex-start; }\nspan.searchFields {\n  margin: 0 10px 10px;\n  flex-grow: 1; }\nspan.searchFields:first-child {\n  margin-left: 0; }\n.form-control {\n  height: 4rem;\n  font-size: 1.4rem; }\ntable th.white-space-nowrap,\ntable td.white-space-nowrap {\n  white-space: nowrap; }\n.incident-facts-brief .btn-primary {\n  margin-left: auto !important;\n  display: block; }\n/* incident facts in brief close */\n/* time required to fix incident start */\n/* time required to fix incident close */\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<!-- reports Section Start -->\n\n<section class=\"vital-registration-page\">\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-8\">\n        <div class=\"section-wrapper\">\n          <div class=\"section-title\">\n            <div class=\"title\" *ngIf=\"lanValue == 'en'\">\n              Reports\n            </div>\n\n            <div class=\"title\" *ngIf=\"lanValue == 'np'\">\n              रिपोर्टहरू\n            </div>\n\n          </div>\n          <div class=\"section-blurb report\">\n            <div class=\"blurb-detail\">\n              <p>\n              </p>\n              <ul class=\"list-group\">\n                <li *ngFor=\"let data of this.reportList\">\n                  <div class=\"title-wrapper\">\n                    <a *ngIf=\"lanValue == 'en'\" [href]=\"environment.url +'/' +data.file\"\n                      target=\"_blank\">{{data.titleInEnglish}}</a>\n                    <a *ngIf=\"lanValue == 'np' && data.titleInNepali != 'null' && data.titleInNepali != ''\"\n                      [href]=\"environment.url +'/' +data.file\" target=\"_blank\">{{data.titleInNepali}}</a>\n                    <a *ngIf=\"lanValue == 'np' && (data.titleInNepali == 'null' || data.titleInNepali == '')\"\n                      [href]=\"environment.url +'/' +data.file\" target=\"_blank\">-</a>\n                  </div>\n                  <div class=\"blurb-duration\">\n                    <i class=\"fa fa-clock-o\" aria-hidden=\"true\"></i>\n                    <span> {{data.createdOn | date: 'yyyy/MM/dd'}}</span>\n                  </div>\n                </li>\n              </ul>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n\n<!-- reports Section Closed -->\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _reports_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reports.service */ "./src/app/reports/reports.service.ts");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var _services_localstorage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/localstorage.service */ "./src/app/_services/localstorage.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReportsComponent = /** @class */ (function () {
    function ReportsComponent(service, localStorageService) {
        this.service = service;
        this.localStorageService = localStorageService;
    ...
    Object.defineProperty(ReportsComponent.prototype, "lanValue", {
        get: function () {
            return this.localStorageService.getLanguage();
        },
        enumerable: true,
    ...
    ReportsComponent.prototype.getReport = function () {
        var _this = this;
        this.service.getReport().subscribe(function (response) {
            console.log(response);
            _this.reportList = response.reverse();
        });
    };
    ReportsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_reports_service__WEBPACK_IMPORTED_MODULE_1__["ReportService"]],
            styles: [__webpack_require__(/*! ./reports.component.scss */ "./src/app/reports/reports.component.scss")]
        }),
        __metadata("design:paramtypes", [_reports_service__WEBPACK_IMPORTED_MODULE_1__["ReportService"],
